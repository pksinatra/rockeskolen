...
<body>
  <main class="cl-page chord-notes-page">
    <section class="cl-hero chord-notes-hero">
      <p class="cl-eyebrow">ChordLink Beta</p>
      <h1>Chord Notes</h1>
      <p class="cl-lead">Explore the notes inside a chord, see them on the staff and piano keyboard, and listen to the chord or arpeggio.</p>
    </section>
    ...
    <section class="cl-info-panel">
      ...
      <p>Chord Notes breaks down chord symbols into actual notes. It is useful for songwriting, arranging, improvisation and learning harmony by connecting notation, keyboard layout and sound.</p>
    </section>
  </main>
