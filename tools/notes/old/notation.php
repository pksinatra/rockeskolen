...
<div class="wrap">
  ...
  <div class="panel">
    ...
    <div class="controls">
      ...
      <span id="scaleFields" class="row" style="display:none">
      ...
      <label style="display:none">Oct <input id="oct" type="number" value="4" min="0" max="8"></label>
      <label style="display:none">Tempo <input id="tempo" type="number" value="90" min="30" max="220"></label>

      <button id="btnApply" style="display:none">Vis</button>
